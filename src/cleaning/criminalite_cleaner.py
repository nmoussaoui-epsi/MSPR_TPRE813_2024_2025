...
class CriminaliteCleaner(DatasetCleaner):
    FOLDER_MAP = {
    ...
    def run(self) -> None:
        self._log("Traitement des données de criminalité...")
        all_criteres = {}
        ...
        output_path = CLEAN_DIR / "criminalite_clean.csv"
        final_df.to_csv(output_path, index=False)
        self._log(f"criminalite_clean.csv généré avec {len(final_df)} lignes")
